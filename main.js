...
if (orignalpincode === message.pincode) {
    ...
    if (message1.operator === "Cash Withdrawl") {
        ...
        if (message2.withdrwal_amount <= AccountBalance) {
            console.log(`Withdrawl Successfull \n Your New Balance is ${AccountBalance - message2.withdrwal_amount} ${currency}`);
        }
        else {
        ...
        if (message3.FastCash === "1000") {
            console.log(`Transaction Successfull \n Your New Balance is ${AccountBalance - 1000} ${currency}`);
        }
        if (message3.FastCash === "5000") {
            console.log(`Transaction Successfull \n Your New Balance is ${AccountBalance - 5000} ${currency}`);
        }
        if (message3.FastCash === "10000") {
            console.log(`Transaction Successfull \n Your New Balance is ${AccountBalance - 10000} ${currency}`);
        }
        if (message3.FastCash === "20000") {
            console.log(`Transaction Successfull \n Your New Balance is ${AccountBalance - 20000} ${currency}`);
        }
    }
}
else {
